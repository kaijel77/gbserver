...
router.post('/deckSetting', pscHandler.asyncWrap(async function (req, res) {
    ...
    if(deck_info === null || deck_info === undefined ){
        ...
        deck_info = await deckClass.addSettingDeckInfo(account_info.account_no, deck_type, deck_hero01, deck_hero02, deck_hero03, deck_hero04, deck_hero05, deck_hero06, deck_hero07, deck_hero08);
        if(deck_info === null || deck_info === undefined ){
